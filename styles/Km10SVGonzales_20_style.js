var size = 0;
var placement = 'point';
function categories_Km10SVGonzales_20(feature, value, size, resolution, labelText,
...
case 'Km 0+816':
                    return [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 8.8 + size, points: 4,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(255,0,13,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(0,255,238,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_Km10SVGonzales_20 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Km10SVGonzales_20(feature, value, size, resolution, labelText,
