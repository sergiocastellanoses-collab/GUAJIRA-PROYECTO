var size = 0;
var placement = 'point';
function categories_VaantiguaUribia_18(feature, value, size, resolution, labelText,
        ...
        image: new ol.style.RegularShape({radius: 8.8 + size, points: 4,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(255,0,10,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(0,255,238,1.0)'})}),
...
var style_VaantiguaUribia_18 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_VaantiguaUribia_18(feature, value, size, resolution, labelText,
